...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Moses%20Mulwa%20Francis-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://linkedin.com/in/mosesfrancis-dev)

I build full-stack web applications — from database design and backend APIs to frontend interfaces and production server deployment.
My depth is in backend engineering, but I design in Figma, build frontends with HTML, CSS, JavaScript, and Tailwind CSS, and connect everything to my own APIs.
Currently co-running **[EasyHostels](https://easyhostels.livify.co.ke)**, a live student housing platform, on a Ubuntu VPS I help configure and manage.
...
| **Frontend** | HTML5 · CSS3 · Tailwind CSS · JavaScript · Fetch API · AJAX · DOM manipulation · Responsive design |
| **UI/UX Design** | Figma · Adobe Photoshop · Photopea |
| **Databases** | MySQL · PostgreSQL · Django ORM · schema design · query optimisation |
| **APIs & Integrations** | RESTful API design · M-Pesa API · Gmail API · Google OAuth · Google Sheets API · Groq API |
| **Infrastructure** | Ubuntu Linux · Nginx · Gunicorn · Cloudflare · systemd · SSH · cPanel |
| **Auth & Security** | JWT · Google OAuth 2.0 · RBAC · email token verification |
| **Containers** | Docker · Docker Compose *(beginner — actively using)* |
| **AI & ML** | Groq API · LLaMA 3.3 · OCR · Prophet · scikit-learn |
| **Learning now** | Django REST Framework · React.js · GitHub Actions · CI/CD |
